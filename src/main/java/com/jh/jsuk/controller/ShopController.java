...
//    @ApiOperation("根据店铺id查看店铺信息")
//    @PostMapping("/show")
//    public Result show(@ApiParam(value = "店铺id", required = true) @RequestParam Integer shopId, Integer userId) {
//        ShopPhoneVo shop = shopService.selectShopPhoneById(shopId);
//        // 总访问量+1
...
//    }
//
//    @ApiOperation("根据店铺id查看店铺自己的分类")
//    @PostMapping("/getShopCategoryByShopId")
//    public Result getShopCategoryByShopId(@ApiParam(value = "店铺id", required = true) @RequestParam Integer shopId) {
//        List<ShopCategory> shopCategoryList = shopCategoryService.selectList(new EntityWrapper<ShopCategory>()
//                .eq(ShopCategory.SHOP_ID, shopId));
//        if (CollectionUtils.isEmpty(shopCategoryList)) {
//            return new Result().success(null);
//        } else {
//            return new Result().success(shopCategoryList);
//        }
//    }
//
//    @ApiOperation("根据商家自己的分类查询商品")
